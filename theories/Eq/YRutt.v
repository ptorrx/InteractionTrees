...
Section euttge_trans_clo.
  ...
  Variant euttge_trans_clo (r : itree E1 R1 -> itree E2 R2 -> Prop) :
   ...
   | eqit_trans_clo_intro t1 t2 t1' t2' RR1 RR2
                         ...
                         (REL: r t1' t2')
                         (LEER1: forall (e1: E1 void) y y',
                             RR2 y y' -> ER1 _ e1 y' -> ER1 _ e1 y)
                         (LEER2: forall x x' (e2: E2 void),
...
Proof.
  ...
  2: { red. rewrite OE1, OE2. econstructor; eauto with paco.
       red in REL.
       rewrite OE1 in REL.
       gstep. red.
       assert (t1 = Vis e k) as K1.
       { simpl. inversion OE1; subst.
         eapply itree_eta_. }
       inv K1.
       setoid_rewrite <- OE1. simpl.
       eauto with paco.
       admit.
   (*    setoid_rewrite (itree_eta t1) in OE1.
       red. econstructor. econstructor. econstructor.
       pstep. red. red. *)
  }
