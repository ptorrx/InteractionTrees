...
(** OK *)
Definition eq_RE {E1: Type -> Type} {R2: Type}
  (REv1 REv2 : forall A, E1 A -> R2 -> Prop) : Prop := 
  forall A, eq_rel (REv1 A) (REv2 A).
...
Definition gen_eq_EE {E1 E2} (TR: Type -> Type -> Type)
  (FR: forall X1 X2, TR X1 X2 -> E1 X1 -> E2 X2 -> Prop)
  (EE1: forall X, E1 X -> bool) (EE2: forall X, E2 X -> bool) :=
  forall X1 X2 (e1: E1 X1) (e2: E2 X2) (tr: TR X1 X2),
    FR X1 X2 tr e1 e2 ->
    EE1 X1 e1 = EE2 X2 e2.

Definition dep_eq_EE {E1 E2: Type -> Type} 
  (TR: forall X1 X2, E1 X1 -> E2 X2 -> Prop)
  (EE1: forall X, E1 X -> bool) (EE2: forall X, E2 X -> bool) :=
  forall X1 X2 (e1: E1 X1) (e2: E2 X2),
    TR X1 X2 e1 e2 -> 
    EE1 X1 e1 = EE2 X2 e2.
...
#[global] Instance EE_Proper_R {E1 E2}
  (EE1: forall X, E1 X -> bool)
  (EE2: forall X, E2 X -> bool) :
  Proper (eq_RAns    (* RAns *)  
      ==> eq         (* X *)
      ==> eq_RAns    (* RAns *)       
      ==> eq) (@rutt E1 E2 R1 R2 EE1 EE2).
Proof.
  intros REv1 REv2 HREv RAns1 RAns2 HRAns RR1 RR2 HRR
    t1 _ <- t2 _ <-.
...
(*
Definition EE_pair E1 E2 (RAns: forall A B, E1 A -> A -> E2 B -> B -> Prop)
  {A B}:
    relationH (E1 A * A) (E2 B * B) :=
  fun '(e1, a) '(e2, b) => RAns A B e1 a e2 b.
*)
